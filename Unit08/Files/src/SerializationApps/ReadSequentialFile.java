package SerializationApps;// Fig. 15.13: ReadSequentialFile.java
...
public class ReadSequentialFile {
    public static void main(String[] args) {
        ...
        try (BufferedReader input =
                     Files.newBufferedReader(Paths.get("clients.json"))) {
...
//         Accounts accounts = JAXB.unmarshal(input, Accounts.class);
            ...
            //read Json file
            Gson gson = new Gson();
            Accounts accounts = gson.fromJson(input, Accounts.class);
